...
class Workout_TrackerTests: XCTestCase {
    ...
    func testAddNewExercise() {
        ...
        exercises.addExercise(Exercise(name: name, notes: notes, workoutDiary: List<Workout>(), goal: goal))
        XCTAssertEqual(exercises.program[0].currentWeights.warmup50.barText, "Bar + 2x10 + 2x5")
