...
class MasterTableViewController: UITableViewController, ExerciseDetailTableViewControllerDelegate {
    ...
    func loadSampleProgram() {
        let squat = Exercise(name: "Squat", notes: "Squat notes", workoutDiary: List<Workout>(), weight: 0, goal: 320)
        ...
        let bench = Exercise(name: "Bench Press", notes: "Bench Press notes", workoutDiary: List<Workout>(), weight: 0, goal: 240)
        ...
        let row = Exercise(name: "Bent Over Row", notes: "Bent Over Row notes", workoutDiary: List<Workout>(), weight: 0, goal: 240)
        ...
        let ohp = Exercise(name: "Overhead Press", notes: "OHP notes", workoutDiary: List<Workout>(), weight: 0, goal: 160)
        ...
        let sldl = Exercise(name: "Straight Leg Deadlift", notes: "SLDL notes", workoutDiary: List<Workout>(), weight: 0, goal: 240)
        ...
        let chin = Exercise(name: "Chin-up", notes: "Chin notes", workoutDiary: List<Workout>(), weight: 0, goal: 240)
        ...
        let calf = Exercise(name: "Calf Raise", notes: "calf notes", workoutDiary: List<Workout>(), weight: 0, goal: 320)
        ...
        let torso = Exercise(name: "Torso Rotation", notes: "torso notes", workoutDiary: List<Workout>(), weight: 0, goal: 240)
        ...
        let curl = Exercise(name: "Curl", notes: "curl notes", workoutDiary: List<Workout>(), weight: 0, goal: 120)
