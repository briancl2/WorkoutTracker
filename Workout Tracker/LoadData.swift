...
func LoadDataDefaults() {
    ...
    let exercises = ExerciseProgram(name: "Allpro Auto-regulated", startDate: NSDate(), program: List<Exercise>(), userProfile: User(bodyWeight: 160, name: "Brian", age: 34))
    
    try! realm.write {
        realm.add(exercises)
        exercises.program.append(squat)
        exercises.program.append(bench)
        exercises.program.append(row)
        exercises.program.append(ohp)
        exercises.program.append(sldl)
        exercises.program.append(chin)
        exercises.program.append(calf)
        exercises.program.append(torso)
        exercises.program.append(curl)
    }
}
